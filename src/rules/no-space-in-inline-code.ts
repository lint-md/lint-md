...
import type { LintMdRule, LintMdRuleContext, MarkdownOffsetLocation } from '../types';
...
const runReport = (ctx: LintMdRuleContext, node: MarkdownCodeNode, value: string, fenceLength: number, loc: MarkdownOffsetLocation) => {
  ctx.report({
    loc,
